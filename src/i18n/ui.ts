...
export const ui = {
    ...
    fr: {
        ...
        'use-cases.no-results': 'Aucun cas d\'utilisation trouvé correspondant à vos critères.',
        'use-cases.no-results-description': 'Essayez d\'ajuster vos filtres ou vos termes de recherche.',
        ...
        'use-cases.filter.sort': 'Trier',
        'use-cases.filter.search': 'Rechercher',
        'use-cases.sort.date-desc': 'Plus Récent d\'Abord',
        'use-cases.sort.date-asc': 'Plus Ancien d\'Abord',
