...
filled: false
description: PhD position in Human-Computer Interaction and Virtual Reality
  focusing on immersive interfaces for digital twin systems
requirements:
...
The position is based at Université Paul Sabatier in Toulouse, within the ELIPSE team at IRIT. You will work under the supervision of Prof. Emmanuel Dubois and collaborate with researchers across the EDT consortium. You will be co-supervised by Associate Professor Cédric Fleury from IMT Atlantique Brest and INUIT team of Lab-STICC.
...
**Supervisor**: Prof. Emmanuel Dubois  
...
For technical questions about the research, please contact Prof. Dubois directly. For administrative questions, contact the HR department.

## About University Paul Sabatier ans IRIT Elipse
