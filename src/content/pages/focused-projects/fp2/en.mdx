...
The challenges relate to how DTs can be modularized to allow composition at both design time and deployment time, at both syntactic (concrete form of interfaces) and semantic levels (ontology alignments). This modularization also concerns the services provided by DTs, including data processing and what-if exploration based on machine learning.
...
**Partners:** P4S (IMT), List (CEA), CRAN (CNRS), DISP (Univ. Lumière Lyon 2), UPPA
...
**Leader:** P4S (IMT)  
**Partners:** DiverSE (Inria), DISP (Univ. Lumière Lyon 2), CIAD (U. de Bourgogne)
...
**Leader:** Moex (Inria)  
**Partners:** Wimmics (Inria), IRIT/SM@RT (Univ. Toulouse Jean Jaurès), IGN
