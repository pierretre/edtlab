...
import avatar from '@assets/images/investigators/jmj.jpg';
...
<PartnersGrid partners={['Inria', 'IMT', 'Université de Bourgogne', 'DISP', 'UPPA', 'Université de Rennes', 'Université Toulouse Jean Jaurès']} ></PartnersGrid>
