...
headline="Professeur des universités, IMT Atlantique"
picture="/media/uploads/ab.png"
>
Antoine Beugnard a obtenu son doctorat en informatique à l'Université de Rennes 1 en 1993 et est professeur au département informatique de Telecom Bretagne, aujourd'hui IMT Atlantique, depuis décembre 2007.

Il a auparavant travaillé pour Michael Jackson France, où il a développé un environnement en Smalltalk pour la méthode JSD (Jackson System Development).

Après s'être intéressé à la sémantique du lien tardif dans les langages orientés objet, aux spécifications orientées contrat et aux abstractions de communication, ses domaines de recherche récents portent sur la modélisation (sa signification, ses notations, ses propriétés telles que la composabilité, etc.) ainsi que sur l'analyse statique des noms dans le contexte de langages hétérogènes.

Depuis 2017, il applique ses recherches au domaine de « l'usine du futur », et plus spécifiquement aux jumeaux numériques.
</PrincipalInvestigator>

### Partenaires Participants :

<PartnersGrid partners={['Inria', 'Université Lumière Lyon 2', 'Université Toulouse Jean Jaurès', 'Université de Lille', 'CNRS', 'CEA', 'IMT Atlantique', 'INSA Rennes']} />
...
<details>
<summary><h3 class="my-2">Workpackage1 : Méthodologie et Cycle de Vie</h3></summary>
...
<details>
<summary><h3 class="my-2">Workpackage2 : Ingénierie Continue, Co-évolution et Qualité, Durabilité</h3></summary>

**Responsable :** LaBRI (CNRS), Spirals (Inria)
...
**Tâches Clés :**
. Développer des cadres de gestion de co-évolution
. Créer des méthodologies d'intégration continue pour les JN
. Implémenter des méthodes VVUQ intégrées dans le cycle de développement
. Automatiser l'évaluation de conformité avec des outils pilotés par IA
. Établir des méthodologies de déploiement continu pour les JN
. Développer un cadre d'évaluation de durabilité basé sur le PCR de l'ADEME
. Implémenter des lignes directrices d'éco-conception pour le cycle de vie des JN
. Créer une intégration analyse-en-boucle pour l'optimisation des performances

</details>

<details>
<summary><h3 class="my-2">Workpackage3 : Ingénierie Collaborative et IDE Augmenté</h3></summary>
