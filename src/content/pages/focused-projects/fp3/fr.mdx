...
headline="Senior Fellow au CEA dirigeant l'Ingénierie Collaborative et Cognifiée Numérique"
picture={avatar}
>
Sébastien Gérard est Senior Fellow au CEA où il dirige le programme phare, Ingénierie Collaborative et Cognifiée Numérique de l'institut CEA LIST. Ses intérêts de recherche incluent les systèmes complexes, l'ingénierie basée sur les modèles, la cognification, l'ingénierie des connaissances et la modélisation visuelle, les outils collaboratifs, la transformation numérique et son impact sur la société. Il représente le CEA à l'OMG depuis plus de 20 ans, a initié et dirigé pendant plus de 15 ans le projet open-source Papyrus (www.eclipse.org/papyrus), et représente le CEA List au conseil d'administration de la fondation Eclipse.
</PrincipalInvestigator>

### Partenaires Participants :

<PartnersGrid partners={['CEA', 'CNRS', 'Inria', 'INRAE']} ></PartnersGrid>

## Mise en Œuvre du Projet

Le projet est structuré en **quatre packages de travail interconnectés**, abordant la méthodologie, l'ingénierie continue, les outils collaboratifs et la durabilité.
...
**Partenaires :** DISP (Univ Lumière Lyon 2), Diverse (Inria), IRIT/SM@RT (Univ. Toulouse Jean Jaurès), List (CEA), Spirals (Inria), IGN, TSCF (INRAE)
