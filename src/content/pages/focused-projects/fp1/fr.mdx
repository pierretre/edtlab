...
description: Développement d'approches systématiques pour combiner modèles
  physiques et modèles basés sur les données via des interfaces standardisées et
  des opérateurs d'hybridation dans les jumeaux numériques
---
## Aperçu
...
* la mise en oeuvre d’outils appropriés de vérification et de validation pour alimenter ces interfaces.
...
<PartnersGrid partners={['Inria', "Université Côte d'Azur", 'INRAE', 'UPPA', 'Télécom Paris', 'CEA', 'Université de Toulouse', 'IMT Atlantique', 'ENSEEIHT / IRIT-ACADIE', 'CNRS/IRIT-ACADIE']} />
