...
title: "Improving Sustainability in the Physical-to-Digital Twin Continuum: A Middleware Framework for Adaptive Deployment" # Avoid accents in title
type: "PhD"  # Options (Limited): "PostDoc", "PhD", "Engineer", "Intern"
pc: PC3
location: "Lille & Rennes, France"
expectedStartDate: "Fall 2026"  # Expected start date - flexible format: "Spring 2025", "Q2 2025", "2025-06-01", etc.
publishedDate: 2026-04-09  # Date when job offer was published in YYYY-MM-DD format
filled: false  # Position availability status: true if position is filled, false if still available
description: "PhD position in the area of sustainable middleware for digital twins." # Brief summary of the position (2-3 sentences) for list summary printing. The detailed description goes in the Body section below.
