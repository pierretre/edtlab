---
title: "A software engineering approach to ease the development and to ensure the usability of interactive digital twins"
type: "PhD"
pc: PC5
host: INSA Rennes, IRISA (Diverse)
supervisors:
  - name: Arnaud BLOUIN
    org: INSA Rennes, IRISA (Diverse)
    role: director
  - name: Philippe PALANQUE
    org: Université Toulouse, IRIT (ICS)
    role: co-supervisor
startDate: 2026-09-01
researchStatus: ongoing
filled: true
researcher:
    name: Mohamed Said Aimen LAMRI
